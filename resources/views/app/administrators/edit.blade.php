                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" value="{{$administrators->password_}}" disabled>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-5">
                                ...
                                <input id="no_telp" name="no_telp" value="{{$administrators->no_telp}}"  maxLength="15" type="text" class="form-control" onkeypress="return isNumberKey(event)">
                            </div>
                        </div>
